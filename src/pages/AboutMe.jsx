            ...
            <GlassFrame>
                ...
                <div className="experiences">
                    ...
                    <div className="exp-info">
                        ...
                        <Experience experience={{ logo: pr2, company: "PK Identitas Unhas", year: "2023-2025", role: "Photographer Coordinator", desc: "I joined Identitas Unhas as an intern. Besides reporting, I worked as a graphic designer for article covers and infographics. I now serve as photography coordinator and editor for the Potret and Identitas English sections. During my time at Identitas, I learned to be disciplined, punctual, and responsible for the weekly tasks assigned to me." }} />
                        <Experience experience={{ logo: pr2, company: "UKM Fotografi Unhas", year: "2024-2025", role: "Coordinator of Information and Communication", desc: "As coordinator of the Unhas Photography Student Club, I delegated tasks and guided members while also taking on the role of designer. I designed the club’s Instagram feed, created templates to improve workflow, and collaborated on developing a website to showcase members’ works. Through this role, I gained deeper experience in leadership." }} />
                        <Experience experience={{ logo: pr3, company: "Forbes Games", year: "2023", role: "Coordinator of Publication and Documentation", desc: "This was my first experience as a coordinator, where I learned many things such as teamwork, assigning tasks based on each member’s abilities, and communicating with other divisions to complete projects. I was also responsible for designing the Instagram feed for Forbes Games 2023." }} />
                        <Experience experience={{ logo: pr3, company: "International Office of Unhas", year: "2024", role: "Intern", desc: "Selected as one of 180 applicants, I volunteered as a student representative where I served as MC, assisted international students, welcomed guests at the airport, and coordinated the Pakistan booth. Through this role, I gained insight into university-level international affairs and expanded my professional network." }} />
                        <Experience experience={{ logo: pr3, company: "PK Identitas Unhas' 50th Anniversary", year: "2024", role: "Treasurer", desc: "In this role, I challenged myself to try something I usually avoid—accounting. As treasurer, I recorded cash inflows and outflows, managed and compiled the finances for the 50th Dies Natalis of PK Identitas Unhas, and had the opportunity to sharpen my Excel skills." }} />
                    </div>
                </div>
                ...
                <Link className="aboutme-btn" to="/contact"><button className="aboutmeBtn">Contact me</button></Link>
            </GlassFrame>
        </div>
    )
}
